...
export function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="container relative mx-auto px-4 pt-0 md:pt-20">
        ...
        <div className="items-center justify-center text-center">
          ...
          >
            <h1 className="md:text-8xl text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-neutral-950 via-neutral-500 to-neutral-950 dark:from-white dark:via-neutral-400 dark:to-white">
              Transformando <br />
